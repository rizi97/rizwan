(function ($) {
  ...
  $(".portfolio-modal-box button.close").on("click", function(){
    $(".portfolio-modal-box").removeClass("show");
    $(".portfolio-modal-box").hide();
  });


  $(".fillter-item-wrap.category-specific .isotop-item").on("click", function(e) {
    e.preventDefault();

    $(".portfolio-modal-box").addClass("show");
